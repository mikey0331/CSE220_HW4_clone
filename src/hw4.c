    ...
    switch (game->phase) {
        ...
        case 1:
            ...
            for (int i = 0; i < MAX_SHIPS; i++) {
                ...
                for (int j = 0; j < 4; j++) {
                    int new_row = row + TETRIS_PIECES[piece_type][j][0];
                    int new_col = col + TETRIS_PIECES[piece_type][j][1];
                ...
                for (int j = 0; j < 4; j++) {
                    ...
                    current->ships[i].cells[j][0] = new_row;
                    current->ships[i].cells[j][1] = new_col;
                }
